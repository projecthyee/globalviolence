...
### Limitations
* Comparability: "functioning of the criminal justice system, the state in the investigation
during which the data are recorded (e.g., when it is reported or after investigation) and the adoption
of international statistical definition at the national level can impact the comparability of these data
between countries" (Taken from metadata **to be reworded**)
