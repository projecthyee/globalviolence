...
violence_visual_df = 
  ...
  filter(unit_of_measurement == "Rate per 100,000 population",
         between(year, 2015, 2023)) |>
  select(country, region, indicator, category, sex, year, violence_rate = value)

head(violence_visual_df)
```
...
tidied and merged for regression analysis. 
...
datasets, since all of them had the different years as data columns. 
...
the average rates of homicide and violence for regression analysis.
...
retained, since they are required for plotting maps. 
