...
>>>>>>> 1e845c2471f6a8c7aba231895da1351942852f70
```{r }
cor_matrix = 
...
Based on our comparisons of RMSE, we conclude that our best-subset regression 
models are most accurate at predicting the outcome: (1) Violence Rate and (2) 
Homicide Rate. The best-subset regression model for predicting violence 
...
normality, linearity, and homosedascity of the dataset used to produce these 
models. Additionally, transformations to deal with the concerns regarding 
