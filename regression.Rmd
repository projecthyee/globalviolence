...
### Regsubset for Violence Rate
Perform regsubset to predict violence rate using r-squared as criterion
```{r}
...
### Regsubset for Homicide Rate
Predict regsubset to predict homicide rate using R-squared as criterion
```{r}
