...
serve as indicators of the level of criminal activity in a country, as well as 
potential efficacy of law enforcement. Such indicators could be predictive of 
violence in the country. Lastly, alcohol rate is included to address the
possibility that substance usage could influence the occurrence of violence.
...
```{r distributions, fig.width = 10, fig.height = 10, warning = FALSE, message = FALSE, echo = FALSE}
...
merged_violence_df |>
  dplyr::select(homicide_rate:alcohol_consumption_rate) |>
  ggpairs()
```
