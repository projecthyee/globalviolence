...
The results from Cp, however, suggested a model that does not include personnel_rate. We ultimately decided to proceed with the model that includes personnel rate, because in the real-world context, personnel rate should explain some variation in violence rate. 
