...
```{r}
# wanting to look at trends of categories across time faceted by region
simple_violent_offences_df |> 
  ...
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) + 
  labels(title = "Average Violence Rate by Category Across Year and Region",
         xaxis = "Year", yaxis = "Rate (per 100,000 population)")
